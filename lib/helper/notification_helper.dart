...
import 'package:live_app/view/screens/notification/widget/notifiation_popup_dialog.dart';
...
class NotificationHelper {
    ...
    flutterLocalNotificationsPlugin.initialize(initializationsSettings,
      ...
      try {
        ...
        if (load.payload!.isNotEmpty) {
          ...
          if (payload.notificationType == NotificationType.general) {
            Get.offAllNamed(
          ...
          if (Get.find<ChatController>()
            ...
            Get.find<ChatController>().getMessages(
              ...
              NotificationBody(
                ...
                receiverId: message.data['sender_type'] == AppConstants.admin
                    ? 0
                    : null,
              ),
              null,
  ...
  static NotificationBody convertNotification(Map<String, dynamic> data) {
    if (data['type'] == 'general') {
      ...
      return NotificationBody(
        notificationType: NotificationType.message,
        receiverId: data['sender_type'] == 'admin' ? 0 : null,

...
class ZegoUIKitCoreDataMediaImpl extends ZegoUIKitMediaEventInterface {
  ...
  Future<ZegoUIKitMediaPlayResult> play({
    ...
    stateNotifier.value = ZegoUIKitMediaPlayState.loadReady;
  ...
  Future<void> start() async {
    ...
    stateNotifier.value = ZegoUIKitMediaPlayState.playing;
  ...
  Future<void> pause() async {
    ...
    stateNotifier.value = ZegoUIKitMediaPlayState.pausing;
  ...
  void onMediaPlayerStateUpdate(
    ...
    stateNotifier.value = ZegoUIKitMediaPlayStateExtension.fromZego(state);

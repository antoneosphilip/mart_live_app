...
class _ZegoLiveAudioRoomMemberListSheetState
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                userNameItem(user, widget.avatarBuilder),
  ...
  Widget userNameItem(ZegoUIKitUser user, ZegoAvatarBuilder? avatarBuilder) {
...
void showBottomSheetWithSelectMenu(BuildContext context, ZegoUIKitUser user) {
  showModalBottomSheet(
    context: context,

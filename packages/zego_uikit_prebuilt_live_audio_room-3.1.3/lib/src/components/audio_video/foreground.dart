...
import 'block_user_container.dart';
  ...
  void onClicked() {
    ...
    if (null == widget.user) {
      ...
      if (widget.seatManager.localHasHostPermissions &&
        ...
        /// host can kick others off seat
          ..add(ZegoLiveAudioRoomPopupItem(
            ZegoLiveAudioRoomPopupItemValue.leaveRoom,
            widget.config.innerText.leaveRoomDialogInfo.title,
            data: index,
          )
          );
        ...
        showDialog(
          context: context,
          builder: (context) {
            return  BlockUserContainer(user: widget.user,);
          },
        );
      }
    }
